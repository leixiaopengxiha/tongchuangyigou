<template>
	<view class="taohuo_box">
		<view class="taohuo_box_nav">
			...
			<view class="taohuo_xiangqing" v-for="(details,index) in doutaotDetails" :key="index">
				<view class="taohuo_xiangqing_tilte">
					{{ details.sort }}
				</view>
				<view class="taohuo_xiangqing_Price">
					￥{{ details.price }}
				</view>
		...
		<view class="taohuo_box_center">
			...
			<view class="taohuo_box_center_wangyou" v-for="(details,index) in doutaotDetails" :key="index">
				<view class="taohuo_box_center_wangyou_img">
					<image class="taohuo_box_center_wangyou_img" :src="details.photourl" mode=""></image>
				</view>
				...
				<view class="taohuo_box_center_wangyou_jia">
					+关注
				</view>
			</view>
		</view>
		<view class="taohuo_box_footer">
			...
			<view class="taohuo_box_footer_tucao" v-for="(item,index) in jiaLiuyan">
				<view class="taohuo_box_footer_tucao_img">
					<image class="taohuo_box_footer_tucao_img" :src="item.img" mode=""></image>
				</view>
		...
		<view class="taohuo_box_dibu">
			<view class="display">
				...
				<view class="taohuo_box_dibu_xiangyao">
				  我想要
				</view>
			</view>
		</view>
...
<script>
	...
	export default {
		data() {
			return {
				...
				jiaItem: [{
					...
					Price: "23",
					time: "1小时前",
					conent: "可搭配不同系列的堆堆袜，在配上俏皮风格的服装或者复古简约风等等都是非常好看的。"
				}],
				// 发布人假数据
				jiaFabu: [{
				...
				jiaLiuyan:[
					{
						img: "https://dss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=1689053532,4230915864&fm=26&gp=0.jpg",
						title:"你咋不上天呢",
						conent:"可搭配不同系列的堆堆袜，再配上俏皮的风格的服装或者复古简约风等等都是非常好看的。",
						giveUp:"1",
						time:"10分钟前"
					}
				],
		...
		onLoad(e) {
			uni.request({
				url:`${ baseUrl }/squarepanningdetails`,
				method:"POST",
				data:{
					'id':e.taohuoInfoid
				},
