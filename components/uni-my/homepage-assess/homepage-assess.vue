<template>
	<view>
	<view class='nav-boxs'>
		<view class="nav-assess" v-for='(item,index) in items' :key='index'  @click="navbtn(index)"  :class="current==index?'active':''">
			{{item}}
		</view>
	</view>
		        <view class="ass-content" style="padding: 7vw 0vw 0vw 7vw;">
		            <view v-if="current === 0" v-for="item in assesslist">
		            ...
		            <view v-if="current === 1" v-for="item in assesslist">
		            ...
		            <view v-if="current === 2" v-for="item in assesslist">
