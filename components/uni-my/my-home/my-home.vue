<template>
  <view class="my_box">
    ...
    <view class="my_box_top">
      ...
      <view @click="setting">
        <uni-icons class="my_box_top_icons"
                   type="gear"
                   size="23"
                   color="#fff"></uni-icons>
      </view>
    ...
    <view class="my_box_main">
      <image class="my_box_main_img"
             :src="admin.photourl"></image>
      ...
      <view style="text-align: center; display: flex; justify-content: space-between">
        <navigator url="/components/uni-my/my-follow/my-follow"
        ...
        <navigator url="/components/uni-my/homepage-fans/homepage-fans"
                   hover-class="navigator-hover">
          <text>
    ...
    <view class="my_box_main">
      <uni-segmented-control :current="current"
                             ...
                             style-type="text"
                             active-color="#28D2D1"></uni-segmented-control>
      <view class="content">
        <view class="order"
              v-if="current === 0">
          <view class="order1">
            <text>购买订单</text>
            <navigator url="/components/uni-my/my-sellorder/my-sellorder"
                       hover-class="navigator-hover">
        ...
        <view class="order"
          ...
          <view class="order1">
            <text>购买订单</text>
            <navigator url="/components/uni-my/my-buyorder/my-buyorder"
                       hover-class="navigator-hover">
              <text class="order-ri">查看全部></text>
            </navigator>
          </view>
          <view class="orderbuy">
            <view class="">
              <image src='../../../static/myimg/signing.png'
                     style="width: 30px; height: 30px;" />
              <text>订单签收</text>
            </view>
            <view class="">
              <image src='../../../static/myimg/sign.png'
                     style="width: 30px; height: 30px;" />
              <text>已签收</text>
            </view>
            <view class="">
              <image src='../../../static/myimg/service.png'
                     style="width: 30px; height: 30px;" />
              <text>申请/售后</text>
            </view>
          </view>
