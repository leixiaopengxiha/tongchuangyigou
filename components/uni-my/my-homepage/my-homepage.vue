		...
		<view class="homepage_detail" style="border-top: 1px solid #eee;">
				...
				<view class="content">
					<view class="content_my" v-if="current === 0">
						<view class="content_my_box" v-for="item in mylist">
							...
							<view class="content_my_price">
								<text style="font-size: 16px; color: #F56C6C;">{{item.price}}</text>
								<text style="font-size: 12px; padding-top: 1vh; color: #999999;">已有{{item.people}}人收藏</text>
							</view>
						</view>
		...
		data() {
			return {
				...
				mylist:[{
					...
					price:'￥1000',
					people:2,
					image: 'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1602066009997&di=ece1e668c68fb35d5a92951c2d53f427&imgtype=0&src=http%3A%2F%2Fpic63.nipic.com%2Ffile%2F20150330%2F14041019_171152921000_2.jpg'
				},{
					id: 2,
					name: '新款包包',
					price:'￥1000',
				...
				postlist:[
					...
					name: '当当当许愿时间到！啦啦啦',
					people:3,
					image: 'https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=3823498870,2984651727&fm=26&gp=0.jpg'
					},
					{
						id: 2,
						name: '当当当许愿时间到！啦啦啦',
